...
<!-- Site Title  -->
<title>Muscari WOA | ICO Crypto - ICO Landing Page &amp; Multi-Purpose Cryptocurrency HTML Template</title>
<!-- Bundle and Base CSS -->
<link rel="stylesheet" href="assets/css/vendor.bundle.css?ver=1930">
<link rel="stylesheet" href="assets/css/style-muscari.css?ver=1930" id="changeTheme">
<!-- Extra CSS -->
...
<body class="nk-body body-wider mode-onepage">
	<div class="nk-wrap">
		<header class="nk-header page-header is-transparent is-sticky is-shrink" id="header">
                    ...
                    <div class="header-wrap">
                        ...
                        <div class="header-navbar header-navbar-s3">
                            <nav class="header-menu justify-content-between" id="example-menu-04">
                                ...
                                <ul class="menu-btns">
                                    <li><a href="#" data-toggle="modal" data-target="#register-popup" class="btn btn-md btn-auto btn-outline btn-secondary no-change"><span>Sign Up</span></a></li>
                                    <li><a href="#" data-toggle="modal" data-target="#login-popup" class="btn btn-md btn-auto btn-outline btn-secondary no-change"><span>Log In</span></a></li>
                                </ul>
                            </nav>
                        </div><!-- .header-navbar @e -->
                    </div>                                                
			...
			<!-- Banner @s -->
            <div class="header-banner bg-theme-alt header-banner-angled">
                <div class="nk-banner">
                    <div class="banner banner-single tc-light">
                        <div class="banner-wrap">
                            <div class="container">
                                <div class="row align-items-center justify-content-center justify-content-lg-between">
                                    <div class="col-lg-5 col-sm-8 order-lg-last">
                                        <div class="banner-gfx banner-gfx-re-s4">
                                            <img src="images/header/gfx-e.png" alt="header">
                                        </div>
                                        <div class="token-status abs-center token-status-s5 round w-100">
                                    ...
                                    <div class="col-lg-6 col-sm-10 text-center text-lg-left">
                                        <div class="banner-caption cpn tc-light">
                                            <div class="cpn-head">
                                                <h1 class="title title-xl-s2 title-semibold">#1 Best Selling ICO Landing template for ICO Startup Agency</h1>
                                            </div>
                                            <div class="cpn-text">
                                                <p class="lead-s2">Most Trending, Clean and Elegant Design based on deeply research</p>
                                            </div>
                                            <div class="cpn-action">
                                                <ul class="cpn-links">
                                                    <li><a href="#" class="btn btn-outline btn-secondary">Token Distribution</a></li>
                                                    <li><a href="#" class="link"><em class="link-icon fas fa-file"></em> <span>Download Whitepaper</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
                ...
                <div class="header-bubbles">
                    <div class="header-bubbles-single">
                        <div class="header-bubbles-single-1"></div><div class="header-bubbles-single-2"></div><div class="header-bubbles-single-3"></div>
                        <div class="header-bubbles-single-4"></div><div class="header-bubbles-single-5"></div><div class="header-bubbles-single-6"></div>
                    </div>
                </div>
        ...
        <main class="nk-pages nk-pages-angled ov-v bg-transparent">
            <!-- Start Section -->
            <section class="section section-intro bg-transparent pt-0 ov-v">
                <div class="section-bg-angle bg-white"></div>
                <div class="container">
                    <div class="nk-block">
                        <div class="row">
                            <div class="col-md-6">
                                <h6 class="title title-xs">Our <br> Partners</h6>
                                <ul class="partner-list-s3 row flex-wrap-reverse">
                                    <li class="col-4">
                                        <a href="#">
                    ...
                    <div class="nk-block nk-block-about" id="ico">
                        <div class="row align-items-center justify-content-between gutter-vr-30px">
                            <div class="col-md-6 pdb-m">
                                <div class="nk-block-text">
                                    <h2 class="title title-semibold">We’ve built a platform <br>to buy and sell shares.</h2>
                                    <p class="lead-s2">ICO Crypto is a platform for the future of funding that powering dat for the new equity blockchain.</p>
                            ...
                            <div class="col-md-5 pdb-m">
                                <div class="nk-block-img">
                                    <img src="images/muscari/gfx-x-light.png" alt="image">
                                </div>
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .block @e -->
                </div><!-- .conatiner  -->
                <div class="gap-4x d-none d-md-block"></div><div class="gap-10x d-none d-lg-block"></div>
            </section>
            <!-- // -->
            <section class="section tc-light bg-light-alt ov-v">
                <div class="section-bg-angle bg-theme-alt"></div>
                <div class="container">
                    <div class="section-head section-head-s8 wide-sm">
                        <h2 class="title">Problem &amp; Solution</h2>
                        <div class="wide-sm">
                            <p>We are creating tokens to solve the world’s biggest blockchain issues surrounding cross-border payments, data accessibility and payment.</p>
                        </div>
                    </div>
                    <div class="nk-block">
                        <div class="row gutter-vr-30px">
                            <div class="col-12 col-lg-4 order-lg-last">
                                <div class="feature bg-black-14 round feature-s11 boxed boxed-md">
                                    <h6 class="title-xs tc-secondary">Our Solution</h6>
                                    <h2 class="title title-lg">That All Change with ICO Crypto</h2>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                                </div>
                            </div><!-- .col -->      
                            <div class="col-sm-6 col-lg-4">
                                <div class="feature feature-s11">
                                    <h2 class="title title-lg">Problems with Information Sharing</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                                </div>
                            </div><!-- .col -->      
                            <div class="col-sm-6 col-lg-4">
                                <div class="feature feature-s11">
                                    <h2 class="title title-lg">Relation between provider and end-user</h2>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            ...
            <section class="bg-light-alt" id="tokens">
                <div class="section section-x section-tokensale">
                    <!-- Block @s -->
                    <div class="nk-block nk-block-token">
                        <div class="container">
                            <div class="section-head section-head-s5 wide-auto-sm text-center">
                				<h2 class="title title-s2">Pre-Sale &amp; Values</h2>
                            ...
                            <div class="row align-items-center justify-content-between gutter-vr-30px">
                                ...
                                <div class="col-lg-5">
                                    <div class="token-status token-status-s5 bg-theme-alt round tc-light">
                            ...
                            <div class="row gutter-vr-40px">
                                <div class="col-lg-6">
                                    <div class="single-chart text-center">
                                        <h3 class="title title-lg pdb-l">Initial Token Distribution</h3>
                                        <div class="chart">
                                            <img src="images/muscari/chart-g-light.png" alt="chart">
                                        </div>
                                    </div>
                                </div><!-- .col  -->
                                <div class="col-lg-6">
                                    <div class="single-chart text-center">
                                        <h3 class="title title-lg pdb-l">Sale Proceed Allocation</h3>
                                        <div class="chart">
                                           <img src="images/muscari/chart-h-light.png" alt="chart">
                                        </div>
                                    </div>
                                </div><!-- .col  -->
                            </div><!-- .row  -->
            ...
            <section class="section bg-white" id="roadmap">
                <div class="container">
                    <div class="section-head section-head-s5 wide-auto-sm text-center">
                        <h2 class="title title-s2">The Roadmap</h2>
                    ...
                    <div class="nk-block">
                        <div class="row justify-content-center">
                            <div class="col">
                                <div class="roadmap-carousel-container text-center">
                                    <div class="has-carousel roadmap-carousel roadmap-carousel-nav-s2 owl-carousel" data-items="5" data-items-mobile-s="1" data-margin="15" data-navs="true">
            ...
            <!-- // -->
            <section class="section bg-theme-alt tc-light" id="apps">
                <div class="overlay-bars">
                    <div class="overlay-bar-1"></div><div class="overlay-bar-2"></div><div class="overlay-bar-3"></div><div class="overlay-bar-4"></div>
                    <div class="overlay-bar-5"></div><div class="overlay-bar-6"></div><div class="overlay-bar-7"></div>
                </div>
                <div class="container">
                    <div class="section-head section-head-s5 wide-auto-sm text-center">
                        <h2 class="title title-s2">ICO Wallet App</h2>
                    ...
                    <div class="nk-block nk-block-text-wrap">
                        <div class="row align-items-center gutter-vr-30px">
                            <div class="col-lg-6 order-lg-last">
                                <div class="nk-block-img">
                                    <img src="images/app-screens/sc-large-m-dark.png" alt="app">
                                </div>
                            </div><!-- .col  -->
                            <div class="col-lg-6">
                                <div class="nk-block-text">
                                    <p class="lead">ICO Crypto Mobile for the future of funding that powering dat for the new equity blockchain.</p>
                                    ...
                                    <ul class="btn-grp justify-content-center justify-content-md-start">
                                        <li><a href="#" class="btn btn-secondary btn-outline btn-md">Get the app now</a></li>
                                        <li>
            ...
            <!-- // -->
            <section class="section bg-light-alt ov-v" id="team">
                <div class="container">
                    <div class="section-head section-head-s5 wide-auto-sm text-center">
                        <h2 class="title title-s2">The Leadership Team</h2>
                    ...
                    <div class="nk-block nk-block-team-list">
                        <div class="section-head section-head-sm text-center">
                            <h2 class="title-lg-2 title-semibold">ADVISORS</h2>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5">
                ...
                <div class="gap-4x"></div>
                <div class="gap-10x d-none d-lg-block"></div>
            </section>
            <!-- // -->
            <section class="section bg-white ov-v section-angle-top" id="faq">
                <div class="section-bg-angle bg-white"></div>
                <div class="container">
                    <div class="section-head section-head-s5 wide-auto-sm text-center">
                        <h2 class="title title-s2">Frequently Asked Questions</h2>
                    ...
                    <div class="nk-block">
                        <div class="row justify-content-center">
                            <div class="col-xl-8 col-lg-10">
                                <ul class="nav tab-nav tab-nav-s2 tab-nav-center mgb-r">
            ...
            <!-- // -->
            <section class="section section-contact bg-transparent section-angle-bottom ov-v " id="contact">
               <div class="section-bg-angle bg-light-alt"></div>
                <div class="container">
                    <div class="section-head section-head-s5 wide-auto-sm text-center">
                        <h2 class="title title-s2">Get In Touch</h2>
                    </div>
                    <!-- Block @s -->
        ...
        <footer class="nk-footer bg-theme-alt nk-footer-angled">
            <div class="overlay-bars reverse">
                <div class="overlay-bar-1"></div>
                <div class="overlay-bar-2"></div>
                <div class="overlay-bar-3"></div>
                <div class="overlay-bar-4"></div>
                <div class="overlay-bar-5"></div>
                <div class="overlay-bar-6"></div>
                <div class="overlay-bar-7"></div>
            </div>
            <div class="gap-8x"></div>
            ...
            <section class="section section-m bg-transparent tc-light ov-v">
                <div class="container">
                    ...
                    <!-- Block @s -->
                    <div class="nk-block block-partners pdb-r">
                        <ul class="partner-list partner-list-s2 flex-wrap pb-3">
                            <li class="partner-logo-s3"><img src="images/partners/a-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/b-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/c-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/d-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/e-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/f-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/a-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/b-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/c-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3"><img src="images/partners/d-xs-light.png" alt="partner"></li>
                                        ...
                                        <form action="form/subscribe.php" class="nk-form-submit" method="post">
                                            <div class="field-inline field-inline-s4">
                                                <div class="field-wrap">
                                                    <input class="input-solid round required email" type="text" name="contact-email" placeholder="Enter your email">
                                                    <input type="text" class="d-none" name="form-anti-honeypot" value="">
                                                </div>
                                                <div class="submit-wrap">
                                                    <button class="btn btn-round btn-auto btn-md btn-light">Subscribe</button>
                                                </div>
                                            </div>
                                            <div class="form-results"></div>
                                        </form>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <div class="copyright-text copyright-text-s3">
                                        <p><span class="d-block">Copyright &copy; 2019, ICO Crypto. Template Made By <a href="#">Softnio</a> &amp; Handcrafted by iO.</span> All trademarks and copyrights belong to their respective owners.</p>
                                    </div>
                                </div><!-- .col -->
